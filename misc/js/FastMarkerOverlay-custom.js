...
com.redfin.FastMarkerOverlay.prototype.onAdd = function() {
  ...
  this._div.classList.add("customOverlay");
...
com.redfin.FastMarkerOverlay.prototype.draw = function() {
    ...
    if (!this._div) return;
    var overlayProjection = this.getProjection();
    this._div.style.left = overlayProjection.fromLatLngToDivPixel(new google.maps.LatLng(17.093542, -91.933594)).x + 'px';
    this._div.style.top = overlayProjection.fromLatLngToDivPixel(new google.maps.LatLng(17.093542, -91.933594)).y + 'px';
}
