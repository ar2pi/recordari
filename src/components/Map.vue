<template>
  ...
  >
    <gmap-info-window
      ...
      @closeclick="reinitInfoWindow()">{{ infoContent }}</gmap-info-window>
    <gmap-marker
      :key="index"
  ...
  <md-bottom-bar>
    <md-bottom-bar-item @click="show('conciencia')" md-active><img class="opaque" src="../assets/Conciencia.svg">Conciencia</md-bottom-bar-item>
  <md-bottom-bar-item @click="show('reconciliacion')"><img class="opaque" src="../assets/Reconciliacion.svg">Reconciliacion</md-bottom-bar-item>
  <md-bottom-bar-item @click="show('reparacion')"><img class="opaque" src="../assets/Reparacion.svg">Reparacion</md-bottom-bar-item>
  <md-bottom-bar-item @click="show('testimonios')"><img class="opaque" src="../assets/Testimonios.svg">Testimonios</md-bottom-bar-item>
</md-bottom-bar>
  </div>
  </div>
</template>
