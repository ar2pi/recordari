          ...
          <div id="intro-fork"
            ...
            <div class="text-center">
              <div class="row pill fork-element"
                   v-show="!showElement.length || showElement === 'fe1'">
                <div id="btn1"
              ...
              <div class="row pill fork-element"
                   v-show="!showElement.length || showElement === 'fe2'">
                <div id="btn2"
              ...
              <div class="row pill fork-element"
                   v-show="!showElement.length || showElement === 'fe3'">
                <div id="btn3"
              ...
              <div class="row pill fork-element"
                   v-show="!showElement.length || showElement === 'fe4'">
                <div id="btn4"
              ...
              <div class="row pill fork-element"
                   v-show="!showElement.length || showElement === 'fe5'">
                <div id="btn5"
